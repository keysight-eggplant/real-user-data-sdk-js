...
## Examples
### Next.js and React (SPA)

To test certain features and to see it working in a real world scenario, we deployed our tag to a Demo app built on Next.js, React, Redux with soft navigation. You can find the app here: [Github Repo](https://github.com/reck1ess/next-realworld-example-app)
