...
describe('RCI SDK Core', () => {
  ...
  describe('Vanilla JS Tests', () => {
    ...
    describe('Targeting latest browsers', () => {
      ...
      it('should work with the Complex Example On Load example', async () => {
        const testSetup = {
          link: 'http://localhost:3000/examples/Vanilla/ComplexExampleOnLoad/index.html',
          instrumentationWebpackConfig: {
            entryPoint: './examples/Vanilla/ComplexExampleOnLoad/complexExampleOnLoad.js',
            scope: 'implementation',
            rulesTarget: 'current',
            mode: 'development'
          },
        ...
        expect(testSetup.capturedRequests[0].payload.eventEnd).to.be.above(testSetup.capturedRequests[0].payload.eventStart);
        expect(testSetup.capturedRequests[0].payload.eventSource).to.deep.equal(testSetup.link);
        expect(testSetup.capturedRequests[0].payload.eventCategory).to.deep.equal('Complex Example On Load');
      ...
      it('should work with the Complex Example On Load Bootstrapped example', async () => {
        const testSetup = {
          link: 'http://localhost:3000/examples/Vanilla/ComplexExampleOnLoadBootstrapped/index.html',
          instrumentationWebpackConfig: {
            entryPoint: './examples/Vanilla/ComplexExampleOnLoadBootstrapped/complexExampleOnLoadBootstrapped.js',
            scope: 'implementation',
            rulesTarget: 'current',
            mode: 'development'
          },
        ...
        expect(testSetup.capturedRequests[0].payload.eventEnd).to.be.above(testSetup.capturedRequests[0].payload.eventStart);
        expect(testSetup.capturedRequests[0].payload.eventSource).to.deep.equal(testSetup.link);
        expect(testSetup.capturedRequests[0].payload.eventCategory).to.deep.equal('Complex Example On Load Bootstrapped');
